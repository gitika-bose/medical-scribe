...
import type { ProcessedSummaryV14 } from '@/api/appointments';
...
interface AppointmentSummaryV14Props {
  summary: ProcessedSummaryV14;
}

export function AppointmentSummaryV14({ summary }: AppointmentSummaryV14Props) {
  return (
    <>
      {/* 1. Summary */}
      ...
      {summary.diagnosis && <DiagnosisSection diagnosis={summary.diagnosis} headingOverride="Diagnosis & Assessment" />}
      ...
      {/* 11. Recommended questions to ask your doctor */}
