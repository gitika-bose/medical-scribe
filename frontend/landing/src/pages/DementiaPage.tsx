      ...
      <section className="hero">
        <div className="hero-content">
          <div className="hero-text">
            <h1>A trusted companion for dementia patients</h1>
            <p>
              Juno helps dementia patients and their caregivers remember, understand, and share what matters most.
            </p>
      ...
      <section className="features" id="features">
        ...
        <div className="features-grid">
          ...
          <div className="feature-icon">🎙️</div>
            ...
            <p>
              Juno structures all medical information for dementia patients and their caregivers.
              Upload test results or let it take notes for you during appointments, and see the difference.
            </p>
          </div>
          <div className="feature-card">
            <div className="feature-icon">🎙️</div>
            <h3>Takes notes for you</h3>
            <p>
              Let Juno listen in the appointment to get organized summaries with diagnoses, treatment plans, medications, 
              and follow-up instructions intelligently summarized.
            </p>
          </div>
          <div className="feature-card">
            <div className="feature-icon">📝</div>
            <h3>Generate questions during appointments</h3>
            <p>
              During a medical appointment, Juno helps caregivers and patients ask relevant questions 
              so you or your caregiver never leave the appointment room confused.
            </p>
          </div>
          <div className="feature-card">
            <div className="feature-icon">🔒</div>
